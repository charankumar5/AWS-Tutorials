# How the users are created in AWS?
- First users are created with defined name and ID for authentication.
- Then for that user, policies will be attached to provide an access to certain resources only for authorise services in AWS.
